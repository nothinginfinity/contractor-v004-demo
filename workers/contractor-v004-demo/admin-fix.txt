...
async function quickRejectSub(id){
  ...
  try{ await fetch('/api/admin/content-submissions/' + id + '/reject', {method:'POST'}); loadContentHub(); }
  catch(e){ alert(e.message); }
}
